...
Depth is about *signal*. For *detail*, there's also a **"Could your gear capture this detail?"** per-pixel planner: adjust a hypothetical scope's focal length, aperture, or f-ratio and it tells you whether you'd reproduce the image's resolution at 1:1 on your sensor - and the integration time to get there.
